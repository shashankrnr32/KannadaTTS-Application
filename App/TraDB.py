...
# Form implementation generated from reading ui file 'ui/TraDB.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setMinimumSize(QtCore.QSize(1120, 541))
        Dialog.setMaximumSize(QtCore.QSize(1120, 541))
        ...
        self.tableWidget.setStyleSheet(_fromUtf8("opacity:10"))
        ...
        self.export_button.setGeometry(QtCore.QRect(10, 500, 101, 27))
        self.export_button.setObjectName(_fromUtf8("export_button"))
        self.clear_button = QtGui.QPushButton(Dialog)
        self.clear_button.setGeometry(QtCore.QRect(1080, 12, 31, 27))
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Translations List", None))
        self.tableWidget.setSortingEnabled(True)
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Dialog", "ID", None))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Dialog", "English Text", None))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Dialog", "Kannada Text", None))
        self.export_button.setText(_translate("Dialog", "Export to", None))
        self.search_text.setPlaceholderText(_translate("Dialog", "Search for Translation", None))
